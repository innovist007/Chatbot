...
import { WebCrTabs, WEB_CR_TABS } from "@/modules/web_cr/components/WebCrTabs";
import { OverviewTab } from "@/modules/web_cr/components/OverviewTab";
import { FunnelTab } from "@/modules/web_cr/components/FunnelTab";
import { ChannelsTab } from "@/modules/web_cr/components/ChannelsTab";
import { PagesProductsTab } from "@/modules/web_cr/components/PagesProductsTab";
import { WebCrKpiHeader } from "@/modules/web_cr/components/WebCrKpiHeader";
import { useWebCR } from "@/modules/web_cr/useWebCR";
...
export default function WebCrPage({ onAskChat, startDate, endDate, compareStart, compareEnd, hasComparison }) {
  ...
  const {
    ...
    aiSummary, aiPending, filterOpts,
    filters, setters,
    device, setDevice,
    visitor, setVisitor,
