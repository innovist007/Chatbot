...
import { RagStrip } from "@/shared/components/RagStrip";
import { AIFlash } from "@/shared/components/AIFlash";
import { MatrixHeatmap } from "@/shared/components/MatrixHeatmap";
import { AlertsGrid } from "@/shared/components/AlertCard";
import { TatGrid } from "@/modules/supply_chain/components/TatCard";
import { TatPipeline } from "@/modules/supply_chain/components/TatPipeline";
import { Waterfall } from "@/modules/supply_chain/components/Waterfall";
import { NdrFunnel } from "@/modules/supply_chain/components/NdrFunnel";
import { DeliveryDayChart } from "@/modules/supply_chain/components/DeliveryDayChart";
import { TrendControls } from "@/modules/supply_chain/components/TrendControls";
import { SCTrendChart } from "@/modules/supply_chain/components/SCTrendChart";
import { useSupplyChain } from "@/modules/supply_chain/useSupplyChain";
...
export default function SupplyChainPage({ startDate, endDate, compareStart, compareEnd, onAskChat, hasComparison }) {
  ...
  return (
    <div className="space-y-4 px-3 py-4 sm:px-6 sm:py-6">
      ...
      />
      <Card className="p-4">
        {segment === "product" && (!subFilter || subFilter === "all") ? (
          <div className="text-sm text-muted py-12 text-center">
            Select a product from the dropdown above to see its trend
          </div>
        ) : (
