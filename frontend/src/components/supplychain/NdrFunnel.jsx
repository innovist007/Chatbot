...
/**
 * data shape from /supply-chain/ndr-funnel:
 *  { total_orders, ndr_raised, ndr_rate, reattempted, reattempt_rate,
 *    delivered_on_reattempt, reattempt_success_rate, ndr_to_rto,
 *    ndr_to_rto_rate, rto_total }
 */
export function NdrFunnel({ data }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="mt-3 rounded border border-sc-red-mid/60 bg-sc-red-light px-3.5 py-2.5 text-[11px] text-sc-red leading-relaxed">
...
const TONE = {
  blue: "bg-sc-blue-mid",
  red: "bg-sc-red",
  amber: "bg-sc-amber-mid",
  green: "bg-sc-green",
  "red-dark": "bg-sc-red/90",
};
...
function FunnelRow({ label, orders, share, tone, pctLabel }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 h-6 bg-sc-gray-100 rounded relative overflow-hidden">
        <div
          className={cn(
            "h-6 flex items-center px-2 text-[11px] font-semibold text-white",
            TONE[tone]
          )}
